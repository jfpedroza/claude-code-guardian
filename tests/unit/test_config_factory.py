...
class TestRuleFactory:
    ...
    def test_rule_priority_sorting(self):
        merged_data = {
            ...
            "rule.a": PreUseBashRuleConfig.model_validate(
                {"type": "pre_use_bash", "commands": [{"pattern": "a"}], "priority": 100}
            ),
            ...
            "rule.d": PreUseBashRuleConfig.model_validate(
                {"type": "pre_use_bash", "commands": [{"pattern": "d"}], "priority": 100}
            ),
        }
